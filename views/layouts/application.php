...
<html lang="en">
<head>
	<title> CONCAT - Thể hiện sự lịch lãm của phái mạnh! </title>
	<meta charset="utf-8">
	<base href="/WBH_MVC/">
...
<body>
	<header id='header'>
		<a href=""><img src="public/images/logo.png"><h2 class="logo">CONCAT</h2></a>
		...
		<div class="header-detail">
			<p>45 Dũng Sĩ Thanh Khê, Đà Nẵng, Việt Nam<br>
	...
	<nav class="navbar navbar-default" role="navigation" id="nav">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand logo" href="">CONCAT</a>
	...
	<footer>
		<div class="container-fluid">
			<div class="row">
				...
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3833.8699063855042!2d108.17554781478546!3d16.07223928887916!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x314218e34876913b%3A0x262941816b7f38ec!2zVGhhbmggS2jDqiwgVGhhbmggS2jDqiBUw6J5LCBUaGFuaCBLaMOqLCDEkMOgIE7hurVuZywgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1582428656366!5m2!1svi!2s" width="700" height="300" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
				</div>
				<div class="col-lg-4" id="contact">
					<h3>Contact</h3>
					<i class="glyphicon glyphicon-map-marker"></i><span> Thanh Khê, Đà Nẵng</span><br>
					<i class="glyphicon glyphicon-earphone"></i><span> (08) 391 525</span><br>
					<i class="glyphicon glyphicon-envelope"></i><span> CONCAT@gmail.com</span><br>
				...
				<div class="col-lg-12" id="copyright-txt">
					<b>All right reverse, &#169; copyright of CONCAT.com</b>
				</div>
			</div>
		</div>
	</footer>
